  ...
  render() {
    ...
    shadowRoot.innerHTML = `
      <style>
        ...
        body.menu-toggled > #menu > #menu-links > .link:nth-of-type(5) {
          transition-delay: 300ms;
        }
        
        body.menu-toggled > #menu > #menu-links > .link:nth-of-type(6) {
          transition-delay: 350ms;
        }
        
        body.menu-toggled > #menu > #menu-links > .link:nth-of-type(7) {
          transition-delay: 400ms;
        }
        
        body.menu-toggled > #menu > #menu-links > .link:nth-of-type(8) {
          transition-delay: 450ms;
        }
        
        body.menu-toggled > #menu > #menu-links > .link:nth-of-type(9) {
