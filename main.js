...
function updatePlanets() {
  ...
  jupiter.rotation.x += 0.0004;
  jupiter.rotation.y += 0.005;
  jupiter.rotation.z += 0.0004;

  saturn.rotation.x += 0.0005;
  saturn.rotation.y += 0.005;
  saturn.rotation.z += 0.0005;
  saturnGroup.rotation.x += 0.0001;
  saturnGroup.rotation.y += 0.0005;
  saturnGroup.rotation.z += 0.0001;
  saturnRings.rotation.y += 0.0005;
  
  uranus.rotation.x += 0.0005;
  uranus.rotation.y += 0.005;
  uranus.rotation.z += 0.0005;
  uranusGroup.rotation.x += 0.0001;
  uranusGroup.rotation.y += 0.0005;
  uranusGroup.rotation.z += 0.0001;
  uranusRings.rotation.y += 0.0005;
